# A Static implementation of a Youtube Page
## Introduction
...
## Requirements
An **exact replica of a Youtube Page isn't required.** The understanding of `#0969DA working with media and making media elements visible` is important.
